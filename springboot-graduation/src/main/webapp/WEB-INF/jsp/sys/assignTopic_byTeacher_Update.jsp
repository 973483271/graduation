        ...
        <div class="x_content">
            <form class="form-horizontal" id="data-form" onsubmit="return false" data-parsley-validate>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12" >
                        <select class="form-control" id="tEduid" name="tEduid" symbol="${topicMessage.tEduid}">
                ...
                <div class="form-group"  >
                    ...
                    <div id="tSource" class="col-md-6 col-sm-6 col-xs-12" style="background-color: #EAEDF2;margin-left: 10px" symbol="${topicMessage.tSource}">
                        <label class="checkbox-inline">
                            <input checked="checked" type="radio" name="tSource"  value="教师自拟">&nbsp<span style="font-size: 16px">教师自拟</span>
                        </label>
                        <label class="checkbox-inline">
                            <input type="radio" name="tSource"  value="学生自拟">&nbsp<span style="font-size: 16px">学生自拟</span>
                        </label>
                    </div>
                </div>
...
<script>
    $('#data-form').parsley().on('form:submit', function () {
        $.ajax({
            url: '${ctx}/sys/teacher/assignTopicUpdate',
            type: 'post',
