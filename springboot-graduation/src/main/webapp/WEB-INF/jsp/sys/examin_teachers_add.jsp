            ...
            <form class="form-horizontal" id="data-form" onsubmit="return false" data-parsley-validate>
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <%--只能输入至少6位数字--%>
                        <input type="text" name="examinteaId" class="form-control"  required minlength="6"  onkeyup="value=value.replace(/[^\w\.\/]/ig,'')">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="examinteaName" class="form-control"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="form-control "  name="examinteaResEducation">
                ...
                <div class="form-group"  >
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="form-control" name="examinteaEducation">
...
<script>
    $('#data-form').parsley().on('form:submit', function () {
        $.ajax({
            url: '${ctx}/sys/admin/addExaminteacher',
            type: 'post',
