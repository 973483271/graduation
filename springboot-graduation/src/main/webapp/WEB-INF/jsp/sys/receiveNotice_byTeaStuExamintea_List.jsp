...
<script>
    var list_url = '${ctx}/sys/teacher/getReceiveNoticeList';
    // 初始化表格数据
        ...
        columns: [
            {
                ...
                formatter: function(value,row){
                    if(row.status){
                        ...
                        return '<a href="#"  onclick="getNoticeOneData('+row.id+')" style="margin-bottom: 0px;">'+value+'</a><i id="tip" class="tip"/>'
                    }
    ...
    function getNoticeOneData(s) {
        $.ajax({
            url: '${ctx}/sys/teacher/getNoticeOneData/'+s,
            type: 'get',
