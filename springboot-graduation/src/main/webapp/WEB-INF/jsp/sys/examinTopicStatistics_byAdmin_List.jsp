    ...
    <div class="modal-dialog" style="width: 900px">
        <div class="modal-content" >
            ...
            <div class="modal-body" >
                ...
                <br><br>
                <div id="examinTeaTopicNum" style="width: 500px;height:300px;"></div>
            </div>
...
<script>
    var list_url = '${ctx}/sys/admin/examinTopicSituation';
    // 初始化表格数据
        ...
        columns: [
            {
                ...
                field: 'examinTopicNum',
                title: '审核题数',
                sortable: true
            },{
                field: 'examinTopicPassingNum',
                title: '过审题数',
                sortable: true
            },{
                field: 'examinTopicPassingRate',
                title: '过审率',
                formatter: function(value,row){
                        return '<span style="color: #DF072E;font-size: 18px">'+value+'%'+'</span>'+'<a href="#myModal" onclick="examinTopicSituation(\''+row.eduId+'\')" style="float: right">'+' [详情]'+'</a>'
                },
                sortable: true
            }]
    });
    ...
    //查看指定专业的出题详情用于统计图显示
    function examinTopicSituation(s) {
        $.ajax({
            url: '${ctx}/sys/admin/getExaminTopicDetails/' + s,
            type: 'get',
            success: function (response) {
                if (response.code == 0) {
                    // 基于准备好的dom，初始化echarts实例
                    var myChart = echarts.init(document.getElementById('examinTeaTopicNum'));
                    // 指定图表的配置项和数据
                    var option = {
                        title: {
                            text: '审题老师审题情况'
        ...
        var aeatd_url = '${ctx}/sys/admin/getAppointEducationExaminTopicDetails/'+s;
        // 初始化表格数据
            ...
            columns: [
                {
                    ...
                    field: 'examinTopicNumByExaminTea',
                    title: '审核题数',
                    sortable: true
                }, {
                    field: 'examinTopicPassingNumByExaminTea',
                    title: '过审题数',
                    sortable: true
                },{
                    field: 'examinTopicPassingRateByExaminTea',
                    title: '过审率',
