    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            <form class="form-horizontal" id="data-form" onsubmit="return false" data-parsley-validate>
                <input type="hidden" value="${teaUser.examinteaId}" name="examinteaId">
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">
                        工号 <span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="examinteaId" class="form-control" value="${teaUser.examinteaId}" disabled="disabled">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="examinteaName" class="form-control" value="${teaUser.examinteaName}"
                ...
                <div class="form-group" >
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="form-control" id="teaEducation" name="examinteaEducation" symbol ="${teaUser.examinteaEducation}">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">
                        负责专业 <span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="form-control" id="examinteaResEducation" name="examinteaResEducationId" symbol="${teaEdu}">
                ...
                <div class="form-group" >
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="tel" class="form-control" id="teaTelphone" value="${teaUser.examinteaTelphone}" name="examinteaTelphone">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="email" name="examinteaEmail" value="${teaUser.examinteaEmail}" class="form-control col-md-7 col-xs-12">
                    </div>
                </div>
...
<script>
    $('#data-form').parsley().on('form:submit', function () {
        $.ajax({
            url: '${ctx}/sys/admin/examin_teachersUpdate',
            type: 'post',
    ...
    //更新默认选择审核老师负责审核的专业
    var examinEduId = $("#examinteaResEducation").attr("symbol");
    $("#examinteaResEducation").find("option").each(function () {
        if(($(this).attr("value"))==examinEduId) {
            $(this).attr("selected","selected")
        }
    })
</script>
